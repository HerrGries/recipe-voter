...
Meteor.startup(() => {
  ...
  JsonRoutes.add("get", "api/families/:userId", (req, res, next) => familyController.getFamilies(req, res, next));
  ...
  JsonRoutes.add("get", "api/recipes/:familyId", (req, res, next) => recipeController.getRecipes(req, res, next));
  ...
  JsonRoutes.add("get", "api/suggestions/:familyId/:day", (req, res, next) => suggestionController.getSuggestions(req, res, next));
  ...
  JsonRoutes.add("get", "api/votes/:suggestionId", (req, res, next) => voteController.getVotes(req, res, next));
